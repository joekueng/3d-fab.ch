...
public class CustomerOrderInformationController {
    ...
    public CustomerOrderInformationController(OrderInformationService service) { this.service = service; }
    @PostMapping("/resume")
    public InformationDto.Credential resume(@PathVariable UUID id) {
    ...
    public InformationDto append(@PathVariable UUID id, @RequestHeader("X-Information-Token") String token,
        ...
        return service.append(id, token, entry, files);
    }
